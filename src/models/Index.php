...
class Index extends Model
{
	 ...
	 */
	public function execFetchFn(null|string|int $sourceId = null, mixed $extra = null): Generator
	{
		$fetchFn = $this->fetch;
		...
		$result = $fetchFn($this, $sourceId, $extra);
	...
	/**
	 * Returns the Mutex name that is locked when this index is processed and document tracking is enabled.
	 */
	public function getDocumentTrackingMutexName(): string
	{
		return "meilisearch-connect-tracking-{$this->handle}";
	}
}
